        ...
        <section id="contact" className="flex flex-col items-center justify-center w-screen pt-28 pb-72">
            <div className="w-11/12 text-center">
                <div className="flex justify-center pb-20">
                    <h1 className="w-min tracking-wide drop-shadow-sm text-slate-100 font-semibold text-3xl sm:text-4xl">
                      Contact
                    </h1>
                </div>
                <div className="flex-col space-y-4 justify-center items-center">
                    ...
                    <h1 className="text-blue-300 italic pb-4 text-xl sm:text-3xl font-light">contact@ricochetproductions.org</h1>
